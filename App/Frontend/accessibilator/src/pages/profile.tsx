...
const Profile = (props: Props) => {
  ...
  const presetsArr = [
    ...
    `Letter Spacing: ${userSettings.characterSpacing * 10}%`,
  ...
  return (
    <DefaultLayout>
      ...
      <main className='flex flex-1 flex-col justify-center bg-slate-50 py-16 pb-8 text-center text-gray-900'>
        <div className='grid flex-1 grid-cols-4 gap-8 px-16'>
          <div className='col-span-1 flex flex-col items-center rounded border border-gray-400 p-10'>
            <div>
              <Image
                width={256}
                height={256}
          ...
          <div className='col-span-3 flex flex-col rounded border border-gray-400 px-16 py-10 text-left'>
